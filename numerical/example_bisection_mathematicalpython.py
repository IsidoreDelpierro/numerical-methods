#Bisection Algorithm (from Mathematical Python)
...
def bisection(f,a,b,N):
    '''
        ...
        x_N : number
            ...
            The initial interval [a_0, b_0]. If f(m_n) == 0 for some midpoint m_n = (a_n + b_n)/2,
            then the function returns this solution.
            If all signs of values f(a_n), f(b_n) and f(m_n) are the same at any iteration,
            the bisection method fails and returns None.
